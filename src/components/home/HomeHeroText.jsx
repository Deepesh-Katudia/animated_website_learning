...
const HomeHeroText = () => {
  return (
    <div className='font-[font1] pt-5 text-center ' >
      ...
      <div className='text-[4vw] uppercase leading-[5vw] justify-center flex items-start' >Building Scalable <div className='h-[4vw] rounded-full overflow-hidden'><Video /></div> Full-Stack Systems</div>
